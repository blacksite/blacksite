...
class NeuralNetworkNSA:
    ...
    def fit_exp(self, x, y, device, data_set, validator, number_of_detectors):
        # print("Evaluating")
        self.device = device
    ...
    def generate_detectors(self):
        ...
        for i in range(10):
            ...
            # self.futures.append(self.executor.submit(self.generate_detectors_thread))
    ...
    def generate_detectors_thread(self):
        ...
        while True:
            ...
            for mal_type, model in self.validator.items():
                classification = model.classify(detector.get_mean_value())
    ...
    def test_r_value(self, maxes, number_of_samples, labels):
        ...
        for sample_index in range(int(math.sqrt(number_of_threads))):
            self.test_r_value_kernel(maxes, self.best_r_value, sample_index, number_of_samples, labels)
